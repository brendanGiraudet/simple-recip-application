...
namespace simple_recip_application.Data.Migrations
{
    ...
    [Migration("20250720095224_CalendarModelsAndCalendarUserAccessModelsTables")]
    partial class CalendarModelsAndCalendarUserAccessModelsTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("simple_recip_application.Features.RecipePlanningFeature.Persistence.Entites.CalendarUserAccessModel", b =>
                {
                    ...
                    b.ToTable("CalendarUserAccessModels");
                });

            modelBuilder.Entity("simple_recip_application.Features.RecipePlanningFeature.Persistence.Entities.CalendarModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("simple_recip_application.Features.RecipePlanningFeature.Persistence.Entities.PlanifiedRecipeModel", b =>
                {
                    ...
                    b.HasKey("RecipeId", "PlanifiedDateTime", "CalendarId");
            ...
            modelBuilder.Entity("simple_recip_application.Features.RecipesManagement.Persistence.Entites.RecipeTagModel", b =>
                {
                    b.Property<Guid>("RecipeId")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("RecipeTagModels");
                });

            modelBuilder.Entity("simple_recip_application.Features.ShoppingListManagement.Persistence.Entities.ShoppingListItemModel", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("simple_recip_application.Features.RecipePlanningFeature.Persistence.Entites.CalendarUserAccessModel", b =>
                {
                    b.HasOne("simple_recip_application.Features.RecipePlanningFeature.Persistence.Entities.CalendarModel", "Calendar")
                        .WithMany("CalendarUsersAccess")
            ...
            modelBuilder.Entity("simple_recip_application.Features.RecipesManagement.Persistence.Entites.RecipeTagModel", b =>
                {
                    ...
                    b.HasOne("simple_recip_application.Features.TagsManagement.Persistence.Entities.TagModel", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("simple_recip_application.Features.RecipePlanningFeature.Persistence.Entities.CalendarModel", b =>
                {
                    b.Navigation("CalendarUsersAccess");

                    b.Navigation("PlanifiedRecipes");
                });
